...
const navItems = [
  ...
  },
  {
    to: "/broadcasts",
    label: "Broadcasts",
    icon: "M11 5.882V19.24a1.76 1.76 0 01-3.417.592L5.5 14H4a2 2 0 01-2-2v-1a2 2 0 012-2h1.5l2.083-5.832A1.76 1.76 0 0111 5.882zM15.536 8.464a5 5 0 010 7.072M18.364 5.636a9 9 0 010 12.728",
  },
  {
    to: "/settings",
    label: "Settings",
